'''
Author       : Zhijie Yang
Date         : 2024-04-24 21:49:20
LastEditors  : Zhijie Yang
LastEditTime : 2024-04-24 21:51:12
FilePath     : /ChatKBQA/utils/parse_sparql_webqsp.py
Description  : 
...
class webqsp_Parser:
    ...
    def parse_query(self, query, mid_list):
        ...
        # s_expr = '(' + s_expr["?x"] + ')'
        # s_expr = s_expr.replace('xsd:','http://www.w3.org/2001/XMLSchema#')
        return var_dep_list, s_expr
